package com.hanuman.bhagavadgita.webview;
...
import com.hanuman.bhagavadgita.Constants;
import com.hanuman.bhagavadgita.R;
...
//                handleUrlLoad(view, url);
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if(url != null && (url.startsWith("whatsapp://") || url.startsWith("https://www.facebook.com/dialog/share") || url.startsWith("https://twitter.com/intent/tweet?text=")))
                {
