...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://bhagavadgita.io";
    public static String WEBAPP_HOST = "bhagavadgita.io"; // used for checking Intent-URLs
    ...
    public static String USER_AGENT_POSTFIX = "BhagavadGita"; // useful for identifying traffic, e.g. in Google Analytics
